...
import { LogOut, ChevronDown, DollarSign, FileText, PieChart, TrendingUp, X, Plus } from 'lucide-react';

export default function FinancialReportPage() {

  const stats = [
    { title: "Total revenue", value: "10.000B", trend: "+12.5%", icon: DollarSign },
    { title: "Tax", value: "10%", trend: "+1.2%", icon: FileText },
    { title: "Net profit", value: "9.000B", trend: "+12.5%", icon: PieChart },
    { title: "Rating", value: "3.9 (15k)", trend: "+12.5%", icon: TrendingUp },
  ];
    ...
    <div className="space-y-6 pb-10">
      ...
      <div className="flex justify-between items-start">
          <div>
            ...
            <p className="text-sm text-gray-500">Get a clear picture of your business finances — analyze revenue streams, operational costs, and profit margins across all assets.</p>
          </div>
      ...
      <div className="space-y-6">
          ...
          {/* Row 1: Total Revenue Chart */}
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm">
                  <span className="w-3 h-3 rounded-full border border-gray-400 inline-block"></span> Total revenue
              </h3>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm">
                      <span className="w-3 h-3 rounded-full border border-gray-400 inline-block"></span> Total contracts
                  </h3>
              ...
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm">
                      <span className="w-3 h-3 rounded-full border border-gray-400 inline-block"></span> Agent Salary
                  </h3>
                  <div className="h-48 bg-gray-100 rounded-lg w-full"></div>
              </div>
          </div>

          {/* Row 3: Specific Revenue Target (Complex Layout) */}
          <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
              <div className="flex justify-between items-center mb-4">
                  <h3 className="font-bold text-gray-900 flex items-center gap-2 text-sm">
                      <span className="w-3 h-3 rounded-full border border-gray-400 inline-block"></span> Specific revenue target
                  </h3>
              ...
              <div className="flex flex-col md:flex-row gap-6">
                  {/* Chart Area (Left) */}
                  <div className="flex-1 h-64 bg-gray-100 rounded-lg"></div>

                  {/* Tags List (Right) */}
                  <div className="w-full md:w-64 flex flex-col gap-2 relative">
                      {/* Vertical line decoration similar to image */}
