...
import AccountantPaymentTable from '@/app/components/features/accountant/payments/AccountantPaymentTable';
import AccountantPaymentAdvancedSearch from '@/app/components/features/accountant/payments/AccountantPaymentAdvancedSearch';
...
export default function AccountantPaymentsPage() {
  ...
  return (
    <div className="space-y-6">
      ...
      {/* Table */}
      <AccountantPaymentTable />

      {/* Modal Filter */}
      <Modal isOpen={isAdvSearchOpen} onClose={() => setIsAdvSearchOpen(false)} title="Advanced Search">
        <AccountantPaymentAdvancedSearch onApply={() => setIsAdvSearchOpen(false)} onReset={() => {}} />
      </Modal>
    </div>
  );
}