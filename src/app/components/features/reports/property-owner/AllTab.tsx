    ...
    <div className="space-y-6 animate-in fade-in duration-300">
      ...
      <div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
              {/* Chart 1: Total Owners */}
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm">
                      <span className="w-3 h-3 rounded-full border border-gray-400 inline-block"></span> Total Owners
                  </h3>
              ...
              {/* Chart 2: Tier Distribution (New Requested) */}
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm">
              ...
              {/* Chart 3: Total Contribution Value (Splitted) */}
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm">
                      <span className="w-3 h-3 rounded-full border border-gray-400 inline-block"></span> Total Contribution Value
                  </h3>
                  <div className="h-40 bg-gray-100/70 rounded-lg flex items-center justify-center text-gray-400 text-sm">
                      [Chart: Bar]
                  </div>
              ...
              {/* Chart 4: Average Contribution (Splitted) */}
              <div className="bg-white border border-gray-200 rounded-xl p-6 shadow-sm">
                  <h3 className="font-bold text-gray-900 mb-4 flex items-center gap-2 text-sm">
                      <span className="w-3 h-3 rounded-full border border-gray-400 inline-block"></span> Avg Contribution per Owner
                  </h3>
                  <div className="h-40 bg-gray-100/70 rounded-lg flex items-center justify-center text-gray-400 text-sm">
                      [Chart: Line]
                  </div>
