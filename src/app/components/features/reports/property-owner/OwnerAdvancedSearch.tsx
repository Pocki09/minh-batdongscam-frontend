...
const RangeInput = ({ label, placeholderFrom = "3.5", placeholderTo = "---" }: any) => (
    <>
        <div>
    ...
    <div className="flex flex-col h-full">
      <div className="space-y-4 flex-1 overflow-y-auto pr-2 pb-4 custom-scrollbar">
          ...
          <div className="grid grid-cols-2 gap-4">
            ...
            <RangeInput label="value" placeholderFrom="3.5B" />
            <RangeInput label="properties" />
            <RangeInput label="for sales" />
            <RangeInput label="for rents" />
            <RangeInput label="projects" />
            <RangeInput label="ranking" placeholderFrom="3.5B" />
